...
function library:CreateWindow(options, ...)
	...
	PrimordialSpaceLibrary.Name = "     "
	PrimordialSpaceLibrary.Parent = library.gui_parent
	PrimordialSpaceLibrary.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
	PrimordialSpaceLibrary.DisplayOrder = 10
	PrimordialSpaceLibrary.ResetOnSpawn = false
	main.Name = "main"
	main.Parent = PrimordialSpaceLibrary
	...
	function windowFunctions:CreateTab(options, ...)
		options = (options and (type(options) == "string") and resolvevararg("Tab", options, ...)) or options or {
			Name = "PrimordialSpace Style: Elite Lego Hax"
		}
	...
	function windowFunctions:CreateDesigner(options, ...)
		...
		local daaata = {{"AddTextbox", "__Designer.Textbox.ImageAssetID", backgroundsection, {
			Name = "Image Asset ID",
			Placeholder = "rbxassetid://cya, Sythe",
			Flag = "__Designer.Background.ImageAssetID",
			Value = "rbxassetid://cya, Sythe",
